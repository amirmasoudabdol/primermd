...
CSS developed by GitHub. It is very readable, accessible, and responsive. 
You can customize a few things, but not a lot. I am hoping that I can extend
its functionalities that it can use some of the Primer CSS goodies.
...
and, soon hopefully, you can install the released version of primermd from CRAN:
...
I should thank [Garrick](https://github.com/gadenbuie) for his awesome R Markdown themes, [cleanmd](https://github.com/gadenbuie/cleanrmd). I have started this project based on his project, and I have learned so much from it! 🙏🏼
