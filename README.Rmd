...
CSS](http://primer.style/css/) developed by GitHub. It is very readable, 
...
e.g., prism syntax highlight. As said, my main goal is to replicate GitHub's
Markdown rendering, and add some of the features that they are adding to their
website, e.g., check boxes, alerts, etc.
